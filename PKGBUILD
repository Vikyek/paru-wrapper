...
optdepends=('snapper: For pre/post transaction btrfs snapshots'
            'rebuild-check: For checking packages that need a rebuild'
            'anneal: For unmarking manually installed packages')
