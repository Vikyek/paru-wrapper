...
depends=('paru' 'bash' 'python' 'jq' 'curl')
optdepends=('sudo: needed for running paru as normal user'
            'snapper: for creating snapshots during package transactions'
            'rebuild-check: for checking if packages need to be rebuilt'
            'anneal: for managing rebuild queues')
