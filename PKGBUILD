...
optdepends=('snapper: for automatic pre/post transaction snapshots'
            'rebuild-check: for automatic post-transaction rebuild checks'
            'anneal: for automatic rebuild queue unmarking')
