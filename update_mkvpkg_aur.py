...
def alpm_vercmp(a: str, b: str) -> int:
    """
    Compares two Arch Linux package version strings, considering epoch, version, and release.

    @param a - First package version string
    @param b - Second package version string
